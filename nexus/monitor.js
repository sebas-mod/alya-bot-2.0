...
╭━━━〔 👑 𝐐𝐮𝐞𝐞𝐧 𝐋𝐮𝐜𝐢𝐚 〕━━━╮
┃ 🌺 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐭𝐡𝐞 𝐤𝐢𝐧𝐠𝐝𝐨𝐦 𝐨𝐟: @group
┃ 📱 𝐍𝐞𝐰 𝐦𝐞𝐦𝐛𝐞𝐫: @user
┃ 🕒 𝐃𝐚𝐭𝐞: ${new Date().toLocaleDateString()} | 𝐓𝐢𝐦𝐞: ${new Date().toLocaleTimeString()}
┃ 📝 𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧: @desc
┃
┃ 👑 𝕼𝖚𝖊𝖊𝖓 𝕷𝖚𝖈𝖎𝖆 𝐬𝐚𝐲𝐬:
...
text = text.replace('@group', metadata.subject || 'Unnamed Group');
text = text.replace('@desc', metadata.desc || 'No description');
